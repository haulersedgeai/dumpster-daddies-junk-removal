...
export function localBusinessSchema() {
  return {
    ...
    description:
      "Family-owned junk removal in Leander, Cedar Park, and across Central Texas. Same and next-day service, upfront flat-rate pricing, 5.0★ on 104 Google reviews.",
