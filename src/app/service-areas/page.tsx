  ...
  return (
    <>
      ...
      <PageHero
        ...
        intro="Same-day junk removal across Central Texas — Cedar Park, Liberty Hill, Georgetown, Round Rock, Lakeway, Bee Cave, Pflugerville, Hutto, NW Austin, and every town in between."
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-7xl px-4 py-20">
          ...
          <div className="mt-16">
            ...
            <p className="mt-2 text-muted text-sm">Within our 20-mile radius — call to confirm same-day availability.</p>
