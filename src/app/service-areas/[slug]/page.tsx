...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Same-day junk removal, large cleanouts, and dumpster rentals in ${town.name}, TX. Family-owned, flat-rate pricing. 5.0★ on ${site.reviewCount} Google reviews.`,
...
export default async function TownPage({
  ...
  const localFaq = [
    {
      q: `Do you offer same-day junk removal in ${town.name}?`,
      a: `Yes. ${town.name} is well inside our 20-mile radius from Leander, and same-day pickups are standard there. Call before noon for best chances of an afternoon slot.`,
    },
    {
  ...
  return (
    <>
      ...
      <PageHero
        ...
        title={`Junk Removal in ${town.name}, TX`}
        intro={`${town.blurb ?? `${town.name} is right in our service area.`} Same-day pickups, flat-rate pricing, broom-clean finish — 5.0★ on ${site.reviewCount} Google reviews.`}
        breadcrumbs={[
          { name: "Home", href: "/" },
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 prose prose-sm max-w-none text-muted leading-relaxed space-y-4">
              <p>
                We&rsquo;re based in Leander, just {town.distanceMi ?? "a short drive"} miles from {town.name}, which means we can usually be at your driveway the same day you call. Whether you&rsquo;ve got a single couch, a packed garage, or an entire house to clear, the same family-owned crew shows up — on time, in uniform, with a flat-rate quote in hand.
              </p>
              <p>
          ...
          <aside className="card h-fit">
            ...
            <ul className="mt-5 space-y-2 text-sm">
              <li className="flex justify-between border-b border-line pb-2"><span className="text-muted">Same-day service</span><span>Yes</span></li>
